...
notes.get('/', (req, res) => {
  readFromFile('./db/db.json').then((data) => res.json(JSON.parse(data))); // reads all files from json file and then sends it to the client in json format (stringifies and does other fun stuff consult google laster pls)
});
